    ...
    <div class="content">
        <div class="container-fluid pt-4 px-4">
            <div class="bg-secondary text-left rounded p-4">
                ...
                ?>
                <form action="indexAP.php?controller=product&action=update" method="post">
                    <input type="hidden" name="id_prd" value="<?= $product['id_prd'] ?>">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" name="name_prd" value="<?= $product['name_prd'] ?>" required>
                        <label for="floatingInput">Tên sản phẩm</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="file" class="form-control" id="floatingInput" name="img_prd" placeholder="Hình ảnh" required>
                        <label for="floatingInput">Hình ảnh</label>
                    </div>
                    <div class="form-floating mb-3">
                        <select name="id_manufacturer" required>
