        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-secondary text-left rounded p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h1 class="mb-0">Thêm hãng sản xuất</h1>
                </div>
                <form action="indexAP.php?controller=manufacturer&action=store" method="post">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" name="name_manufacturer" placeholder="Tên hãng sản xuất" required>
