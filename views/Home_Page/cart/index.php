                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                                <a href="indexHP.php?controller=customer&action=dangky"><i class="fa fa-user"></i>Đăng xuất</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="indexHP.php?controller=product&action=cuahang">Cửa hàng</a></li>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="shoping__cart__table">
                        <table>
                            ...
                            <tbody>
                            <?php
                                foreach ($infor['cart'] as $id_prd => $value){
                            ?>
                                <tr>
                                    ...
                                    <span class="icon_close"><a href="indexHPHP.php?controller=product&action=delete_product_in_order&id=<?= $id_prd; ?>"></a></span>
                                    </td>
                                </tr>
                                <?php
                                    }
                                ...
                                <!-- <tr>
                                    ...
                                    <td class="shoping__cart__item__close">
                                        <span class="icon_close"><a href="index.php?controller=product&action=delete_product_in_order&id=<?= $id_prd; ?>"></a></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="shoping__cart__item">
