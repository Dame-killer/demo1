    ...
    <div class="content">
        <div class="container-fluid pt-4 px-4">
            <div class="bg-secondary text-left rounded p-4">
                ...
                <form action="indexAP.php?controller=product&action=store" method="post">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" name="name_prd" placeholder="Tên sản phẩm" required>
